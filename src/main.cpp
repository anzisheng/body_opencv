...
public:
	...
	//--------------------------------------------------------------------------  
	// ‘ÛÌÍˆËˇ Ó·‡·ÓÚÍ?Ì‡Ê‡ÚË?ÍÌÓÔÓÍ Ï˚¯Ë
	//--------------------------------------------------------------------------
...
// 	cout << "xyz:" << endl << pred_xyz_jts_29 << endl;
	...
	//save it to file
	cnpy::npy_save("arr1.npy", &data[0], { Nz,Ny,Nx }, "w");//&data[0]: ∆ ºµÿ÷∑

	//load it into a new array
	cnpy::NpyArray arr = cnpy::npy_load("arr1.npy");
	std::complex<double>* loaded_data = arr.data<std::complex<double>>(); //»°µ√ ◊µÿ÷∑
